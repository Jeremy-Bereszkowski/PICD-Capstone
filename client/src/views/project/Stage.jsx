        ...
        return (
            <div className="row justify-content-left content">
                ...
                <div className="col">
                    ...
                    <hr/>
                    <UploadFile projectId={this.props.match.params.projectId} stageId={this.props.match.params.stageId} stageVersion={this.state.selectVersion.version_id}/>
                    <File projectId={this.props.match.params.projectId} stageId={this.props.match.params.stageId} stageVersion={this.state.selectVersion.version_id}/>
                </div>
            </div>
        )
    }
